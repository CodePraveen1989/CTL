...
const TermsConditions = () => {
  return (
    <div className="container"><br/>
        ...
        <h5 class="terms">ACCEPTANCE OF THE TERMS OF USE</h5>
        <p>Welcome to the website of CTL Services (Australia) ("Company", "we" or "us"). The following terms and conditions, together with any documents they expressly incorporate by reference (collectively, these "Terms of Use"), govern your access to and use of <a href="/">ctlservices.com.au</a>, including any content, functionality and services offered on or through <a href="ctlservices.com.au">ctlservices.com.au</a> (the "Website"), whether as a guest or a registered user.</p>
        ...
        <h5 class="terms">CHANGES TO THE TERMS OF USE</h5>
        ...
        <h5 class="terms">ACCESSING THE WEBSITE AND ACCOUNT SECURITY</h5>
        ...
        <h5 class="terms">INTELLECTUAL PROPERTY RIGHTS</h5>
        ...
        <p>If you wish to make any use of material on the Website other than that set out in this section, please address your request to: <a href="mailto:contact@ctlservices.com.au">contact@ctlservices.com.au</a></p>
        ...
        <h5 class="terms">USER CONTRIBUTIONS</h5>
        ...
        {/* <h5 class="terms">USER GENERATED CONTENT</h5>
        ...
        <h5 class="terms">MONITORING AND ENFORCEMENT; TERMINATION</h5>
        ...
        <h5 class="terms">COPYRIGHT INFRINGEMENT</h5>
        <p>If you believe that any User Contributions violate your copyright, please email us at <a href="mailto:contact@ctlservices.com.au">contact@ctlservices.com.au</a>with information regarding the alleged violation. It is the policy of the Company to terminate the user accounts of repeat infringers.</p>

        <h5 class="terms">RELIANCE ON INFORMATION POSTED</h5>
        ...
        <h5 class="terms">CHANGES TO THE WEBSITE</h5>
        ...
        <h5 class="terms">INFORMATION ABOUT YOU AND YOUR VISITS TO THE WEBSITE</h5>
        ...
        <h5 class="terms">LINKING TO THE WEBSITE AND SOCIAL MEDIA FEATURES</h5>
        ...
        <h5 class="terms">LINKS FROM THE WEBSITE</h5>
        ...
        <h5 class="terms">GEOGRAPHIC RESTRICTIONS</h5>
        ...
        <h5 class="terms">DISCLAIMER OF WARRANTIES</h5>
        ...
        <h5 class="terms">LIMITATION ON LIABILITY</h5>
        ...
        <h5 class="terms">INDEMNIFICATION</h5>
        ...
        <h5 class="terms">GOVERNING LAW AND JURISDICTION</h5>
        ...
        <h5 class="terms">LIMITATION ON TIME TO FILE CLAIMS</h5>
        ...
        <h5 class="terms">WAIVER AND SEVERABILITY</h5>
        ...
        <h5 class="terms">ENTIRE AGREEMENT</h5>
        ...
        <h5 class="terms">YOUR COMMENTS AND CONCERNS</h5>
        <p>All other feedback, comments, requests for technical support and other communications relating to the Website should be directed to: <a href="mailto:contact@ctlservices.com.au">contact@ctlservices.com.au</a></p>
