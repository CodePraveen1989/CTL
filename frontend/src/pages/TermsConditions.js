...
const TermsConditions = () => {
    return (
        <div className="container"><br />
            ...
            <p>If you wish to make any use of material on the Website other than that set out in this section, please address your request to: <a href="mailto:admin@ctlservices.com.au">admin@ctlservices.com.au</a></p>
        ...
        <ul class="terms-ul">
            ...
            <h5 class="terms">CONTENT STANDARDS</h5>
            ...
            <p>If you believe that any User Contributions violate your copyright, please email us at <a href="mailto:admin@ctlservices.com.au">admin@ctlservices.com.au</a>with information regarding the alleged violation. It is the policy of the Company to terminate the user accounts of repeat infringers.</p>
            ...
            <p>All other feedback, comments, requests for technical support and other communications relating to the Website should be directed to: <a href="mailto:admin@ctlservices.com.au">admin@ctlservices.com.au</a></p>
