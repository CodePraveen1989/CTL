      ...
      <Row className="justify-content-md-center mt-5">
        ...
        <Col md={6}>
          ...
          >
            ...
            <Row>
              <Form.Group as={Col} md="4" className="mb-3" controlId="formBasicprice">
              ...
              <Form.Group as={Col} md="4" className="mb-3" controlId="formBasicPurchasePrice">
              ...
              <Form.Group as={Col} md="4" className="mb-3" controlId="formBasicSLRBuyingPrice">
            ...
            <Row>
              <Form.Group as={Col} md="6" className="mb-3" controlId="formBasicSLRSKU">
              ...
              <Form.Group as={Col} md="6" className="mb-3" controlId="formBasicCTLSKU">
            ...
            <Row>
              <Form.Group as={Col} md="6" className="mb-3" controlId="formBasicSupplierSKU">
              ...
              <Form.Group as={Col} md="6" className="mb-3" controlId="formBasicSupplier">
